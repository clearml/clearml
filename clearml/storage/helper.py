...
class _Boto3Driver(_Driver):
    ...
    _addressing_style = deferred_config("aws.boto3.addressing_style", None)
    ...
    def _get_boto_resource_kwargs_from_config(cls, cfg: S3BucketConfig) -> Dict[str, Any]:
        ...
        boto_kwargs = {
            ...
            "config": botocore.client.Config(
                ...
                **({"s3": {"addressing_style": _Boto3Driver._addressing_style}} if _Boto3Driver._addressing_style else {}),
            ),
        }
